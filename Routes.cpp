...
public:
    ...
    void setAirline(string airlineCode) {airline = airlineCode;}

    string getAirlineID() {return airlineID;}

    void setAirlineID(string airlineId) {airlineID = airlineId;}

    string getDestinationAirportCode() {return destinationAirportcode;}

    void setDestinationAirportCode(string destinationAirportCode) {destinationAirportCode = destinationAirportCode;}

    void setStops(int stop) {stops = stop;}
    ...
    bool equals(Route new_route){
        // if(new_Route == NULL)
        return stops == new_route.stops && airline == new_route.airline;
    }
